...
import { userExcelUpload } from '../../Service/userExcelUpload'
export default class uploadUserExcel extends Component {
    ...
    constructor(props) {
        ...
        this.uploadUserExcel = this.uploadUserExcel.bind(this)
    }
    ...
    async onSubmit(e) {
        ...
        try {
            ...
            let result = await this.uploadUserExcel(this.state.file);
    ...
    async uploadUserExcel(file) {
        ...
        return await userExcelUpload(formData)
