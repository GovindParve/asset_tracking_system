...
import "./UserList.css";
import { getEmpGpsUser } from "../../Service/getEmpGpsUser";
...
export default class EmpGpsUserList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      offset: 0,
  ...
  handlePageClick = async (e) => {
    ...
    let result = await getEmpGpsUser(selectedPage);
  ...
  async getData() {
    let result = await getEmpGpsUser(this.state.currentPage);
