...
import { getGPSDynamicColumnList } from '../../Service/getGPSDynamicColumnList'
import { Link} from 'react-router-dom';
import swal from "sweetalert";

export default class Gps_AdminTracking extends Component {
  constructor(props) {
    super(props);
    this.state = {
      offset: 0,
  ...
  async componentDidMount() {
    try {
    let resultColumn = await getGPSDynamicColumnList();
