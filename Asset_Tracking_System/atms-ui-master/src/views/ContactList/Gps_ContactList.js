...
import { getGPSContactList } from '../../Service/getGPSContactList'
import ReactPaginate from 'react-paginate';
import { deleteContact } from "../../Service/deleteContact";
import swal from "sweetalert";

export default class Gps_ContactList extends Component {
    ...
    handlePageClick = async (e) => {
        ...
        let result = await getGPSContactList(selectedPage);
    ...
    async getData() {
        let result = await getGPSContactList(this.state.currentPage);
