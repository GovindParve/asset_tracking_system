...
import { getFeedbackList } from '../../Service/getFeedbackList'
...
export default class IssueList extends Component {
    ...
    handlePageClick = async (e) => {
        ...
        let result = await getFeedbackList(selectedPage);
    ...
    async componentDidMount() {
        try {
            ...
            this.getData();
            // let result = await getFeedbackList()
    ...
    async getData() {
        let result = await getFeedbackList(this.state.currentPage);
       ...
       // e.persist()
        ...
        Swal.fire({
           ...
           // text: "You won't be able to revert this!",
            ...
            return Axios.delete(`/issue/delete/${id}`, { headers: { "Authorization": `Bearer ${token}` } })
                .then(resultResponse => {
                    console.log("Delete User", resultResponse);
                          Swal.fire({
                           position: 'top-center',
                            icon: 'success',
                            title: 'Issue Record Is Deleted...!',
