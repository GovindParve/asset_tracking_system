...
import {getDashboardGPSAdminList} from '../../Service/getDashboardGPSAdminList'
...
export default class Dashboard_Gps_AdminList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            offset: 0,
    ...
    async componentDidMount() {
        try {
            ...
            let result = await getDashboardGPSAdminList()
            console.log('GPS Admin List', result)
            this.setState({ allData: result && result.data, Role: setRole, loader: false }, () => {
                console.log('Gps Admin data', this.state.allData)
                let temp = []
