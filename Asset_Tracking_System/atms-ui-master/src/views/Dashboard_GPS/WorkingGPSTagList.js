...
import { getWorkingGPSTagList } from '../../Service/getWorkingGPSTagList'
...
export default class WorkingGPSTagList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            offset: 0,
    ...
    async componentDidMount() {
        try {
            ...
            let result = await getWorkingGPSTagList()
