...
import { getWorkingOrNonGPSTag } from '../../Service/getWorkingOrNonGPSTag'
...
export default class NonWorkingGPSTagList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            offset: 0,
    ...
    async componentDidMount() {
        try {
            //this.getTagData();
            let result = await getWorkingOrNonGPSTag()
