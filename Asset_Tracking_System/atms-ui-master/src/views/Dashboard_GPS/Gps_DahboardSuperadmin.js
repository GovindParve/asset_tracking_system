...
class Gps_DahboardSuperadmin extends PureComponent {
  ...
  async componentDidMount() {
    ...
    this.setState({
      ...
      countOrganigation: resultAllCount && resultAllCount.data && resultAllCount.data.totalOrganigation
            ...
            <div className="header-body">
              ...
              <Col lg="6" xl="4">
                  <Card className="cards mb-4 mb-xl-0 ">
                    <CardBody>
                      <Link to={{ pathname: "/dashboard_Gps_orglist" }}>
                        <Row>
                          <div className="col">
                            <CardTitle
                              tag="h5"
                            ...
                            <span className="h2 font-weight-bold mb-0">{this.state.countOrganigation}</span>
                          </div>
...
export default Gps_DahboardSuperadmin;
