...
import { getDashboardGPSUserList } from '../../Service/getDashboardGPSUserList'
...
export default class Dashboard_Gps_UserList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            offset: 0,
    ...
    async componentDidMount() {
        try {
            ...
            let result = await getDashboardGPSUserList()
