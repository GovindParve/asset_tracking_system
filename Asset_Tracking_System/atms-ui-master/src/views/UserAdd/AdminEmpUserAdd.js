...
export default class AdminEmpUserAdd extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isRevealPwd: false,
    ...
    async componentDidMount() {
        try {
            this.setState({
                loader: true, Role: localStorage.getItem('role'),
                ...
                <Formik
                    ...
                    onSubmit={async values => {
                        ...
                        const data = {
                            ...
                            admin: admin,
                            // fkuserId: this.state.selectedAdminId,
                            // organization: this.state.Role === "organization" ,
                            // organization: this.state.Role === "organization" ? this.state.username : this.state.selectedOrg,
