...
export default class UpdateOrgGateway extends Component {
    state = {
                                ...
                                <Form>
                                    <div className="gatewayUpdate_form">
                                        ...
                                        {(this.state.selectedCategory === 'BLE') ? <>
                                            ...
                                            <div>
                                                {/* <Select options={this.state.allDataAdmin} onChange={this.changeAdmin} placeholder="Select Admin" name="admin" /> */}
                                                <label>Admin</label>
                                                <Select
                                                    value={
                                            ...
                                            {/* <Select options={this.state.allDataUser} onChange={this.changeUser} placeholder="Select User" name="user" /> */}
                                            <div>
                                                <label>User</label>
                                                <Select
                                                    value={
