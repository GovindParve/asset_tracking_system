...
import { getDashboardOrgList } from '../../Service/getDashboardOrgList'
...
export default class DashboardOrgList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            offset: 0,
    ...
    async componentDidMount() {
        try {
            ...
            let result = await getDashboardOrgList()
