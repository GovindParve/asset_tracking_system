...
import { getWorkinOrNonWorkingGateway } from '../../Service/getWorkinOrNonWorkingGateway'
import moment from "moment";
import { getPageWiseGatewayList } from '../../Service/getPageWiseGatewayList'
import ReactPaginate from 'react-paginate';
import swal from "sweetalert";

export default class NonWorkingGateway extends Component {
    constructor(props) {
        super(props);
        this.state = {
            offset: 0,
    ...
    async componentDidMount() {
        try {
            ...
            let result = await getWorkinOrNonWorkingGateway()
            console.log('all Working or Non Working Gateway Data', result)
            // this.setState({ allData: result && result.data, Role: setRole, loader: false }, () => {
            //     console.log('Working or Non Working Gateway Data', this.state.allData)
            // })
