...
import { getDashboardAdminList } from '../../Service/getDashboardAdminList'
...
export default class DashboardAdminList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            offset: 0,
