...
import { getEmpUserForDashboard } from "../../Service/getEmpUserForDashboard";
...
export default class EmpUserListDashboard extends Component {
  constructor(props) {
    super(props);
    this.state = {
      offset: 0,
  ...
  async componentDidMount() {
    try {
      ...
      let result = await getEmpUserForDashboard(this.state.currentPage);
