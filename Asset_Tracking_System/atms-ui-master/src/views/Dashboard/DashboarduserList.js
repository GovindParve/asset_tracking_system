...
import { getDashboardUserList } from '../../Service/getDashboardUserList'
...
export default class DashboarduserList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            offset: 0,
    ...
    async componentDidMount() {
        try {
            ...
            let result = await getDashboardUserList()
