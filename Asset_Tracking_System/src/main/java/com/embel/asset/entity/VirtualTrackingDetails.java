...
@Entity
@Table(name = "virtual_tracking_details")
public class VirtualTrackingDetails 
{
	...
	private String lb14;
	private String lb15;
	public VirtualTrackingDetails() {
		super();
		// TODO Auto-generated constructor stub
	}
	public VirtualTrackingDetails(long trackingId, String tagCategoty, String assetTagName, String gSrNo,
			String assetGatewayName, String assetGatewayMac_Id, String tagEntryLocation, String barcodeSerialNumber,
			float tagDist, String imeiNumber, String uniqueNumberMacId, String latitude, String longitude,
			String currentdate, String time, String existTime, String entryTime, String tagExistLocation,
			String dispatchTime, Integer battryPercentage, String lb1, String lb2, String lb3, String lb4, String lb5,
	...
	public String toString() {
		return "VirtualTrackingDetails [trackingId=" + trackingId + ", tagCategoty=" + tagCategoty + ", assetTagName="
				...
				+ uniqueNumberMacId + ", latitude=" + latitude + ", longitude=" + longitude + ", currentdate="
				+ currentdate + ", time=" + time + ", existTime=" + existTime + ", entryTime=" + entryTime
				+ ", tagExistLocation=" + tagExistLocation + ", dispatchTime=" + dispatchTime + ", battryPercentage="
				+ battryPercentage + ", lb1=" + lb1 + ", lb2=" + lb2 + ", lb3=" + lb3 + ", lb4=" + lb4 + ", lb5=" + lb5
