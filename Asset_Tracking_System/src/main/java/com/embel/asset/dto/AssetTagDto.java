...
//	private String time;
	...
	private String assetTagSubCategory;
	...
	public AssetTagDto(Long assetTagId, String assetTagName, String user, String admin, String organization,
			...
			String assetBarcodeSerialNumber, String assetLocation, String assetTagCategory, String assetTagSubCategory,
		...
		this.assetTagSubCategory = assetTagSubCategory;
		this.status = status;
	...
	public String getAssetTagSubCategory() {
		return assetTagSubCategory;
	}
	public void setAssetTagSubCategory(String assetTagSubCategory) {
		this.assetTagSubCategory = assetTagSubCategory;
	}
	...
	public String toString() {
		return "AssetTagDto [assetTagId=" + assetTagId + ", assetTagName=" + assetTagName + ", user=" + user
				...
				+ assetLocation + ", assetTagCategory=" + assetTagCategory + ", assetTagSubCategory="
				+ assetTagSubCategory + ", status=" + status +", createdBy=" + createdBy
				+ "]";
	}
