...
import com.embel.asset.entity.Role;
...
public class JwtTokenProvider {
	  ...
	  @Value("${Asset_Tracking_System.app.jwtRefreshExpirationMs}")
	  private long refreshValidityMs;
	  @Autowired
	  private MyUserDetails myUserDetails;
	
//	  @Autowired
//	  private EmployeeDetails myEmployeeDetails;
//	  
	  @PostConstruct
	  protected void init() {
...
//			    UserDetails userDetails = myEmployeeDetails.loadUserByUsername(getUsername(token));
