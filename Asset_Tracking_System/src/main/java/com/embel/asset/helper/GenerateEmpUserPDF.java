...
public class GenerateEmpUserPDF {
	//{"SrNo","UserName","FirstName","LastName","PhoneNumber","Email-Id","CompanyName","Address" };
	public static ByteArrayInputStream EmployeeUserPDF(List<EmployeeUser> userList) {
...
//			table.addCell(hcell);
			...
			int icnt=1;
			for (EmployeeUser bean : userList) {
